...
if __name__ == '__main__':
  ...
  parser.add_argument('-i', '--input', required=True, help='Path to original global-metadata.dat')
  parser.add_argument('-p', '--patch', required=True, help='Path to patch file')
  parser.add_argument('-o', '--output', required=True, help='Path to output global-metadata.dat')
