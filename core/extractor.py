...
class StringLiteralExtractor:
  ...
  def _extract(self, f):
    ...
    self._extract_string_literals(f, stringliteral_data_offset, stringliteral_data_size)
  ...
  def _extract_string_literals(self, f, stringliteral_data_offset, stringliteral_data_size):
